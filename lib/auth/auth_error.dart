...
const Map<String, AuthError> authErorMapping = {
  'user-not-found': AuthErrorUserNotFound(),
  'weak-password': AuthErrorWeakPassword(),
  'invalid-email': AuthErrorInvalidEmail(),
  'operation-not-allowed': AuthErrorOperationNotAllowed(),
  'email-already-in-use': AuthErrorEmailAlreadyInUse(),
  'requires-recennt-login': AuthErrorRequiresRecentLogin(),
...
abstract class AuthError {
  ...
  factory AuthError.from(FirebaseAuthException exception) =>
      authErorMapping[exception.code.toLowerCase().trim()] ??
...
class AuthErrorNoCurrentUser extends AuthError {
  const AuthErrorNoCurrentUser()
      : super(
          ...
          dialogText: 'No current user with the information was found',
        );
}

// auth/requires-recennt-login
@immutable
...
class AuthErrorOperationNotAllowed extends AuthError {
  const AuthErrorOperationNotAllowed()
      : super(
          ...
          dialogText: 'You can not register using this methid at this moment',
        );
}
